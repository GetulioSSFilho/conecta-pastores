...
abstract final class MockPastors {
  static const joao = PastorProfile(
    ...
    validUntil: '12/2027',
    bio:
        'Serve na Igreja Monte Carmo desde 2010, com foco em pregação, discipulado e cuidado das famílias da comunidade.',
  ...
  static const carlos = PastorProfile(
    ...
    validUntil: '08/2028',
    bio:
        'Lidera a região de Minas Gerais com foco no cuidado dos pastores, na formação de líderes e na saúde das igrejas locais.',
